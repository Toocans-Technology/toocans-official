...
import { Box, Typography, Button, Stack, Card, CardContent, List, ListItem, ListItemIcon, ListItemText, ListItemSecondaryAction, Divider } from '@mui/material';
    ...
    <React.Fragment>
      <Dialog maxWidth='xs' open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent sx={{ gap: 2, display: 'flex', flexDirection: 'column' }}>
          <Typography>For your account security, this operation is subject to the following conditions.</Typography>

          <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={1} bgcolor="#F8F8F8" p={2} borderRadius={1}>
      ...
      <PageContainer title="Overview" description="Asset Overview">
        ...
        <Box sx={{ 
          ...
          <Typography variant="h2" sx={{ mb: 2, color: '#000' }}>Asset Overview</Typography>
            ...
            <CardContent>
              <Stack spacing={2}>
                <Box sx={{ 
                  ...
                  <Typography variant="subtitle1" color="#666666" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    Total Balance 
                    {showBalance ? (
                      <IconEye 
                        width={16} 
                ...
                >
                  ...
                  >
                      <Button 
                        ...
                        onClick={() => handleButtonClick('deposit')}
                        sx={{ 
                          bgcolor: activeButton === 'deposit' ? '#9CFF1F' : '#E0E0E0',
                          color: 'black',
                          '&:hover': {
                            bgcolor: activeButton === 'deposit' ? '#9cff1f' : '#D0D0D0'
                          },
                          borderRadius: 36,
                          flex: { xs: 1, sm: 'initial' },
                          px: { xs: 2, sm: 3 }
                      ...
                      <Button 
                        ...
                        sx={{ 
                          bgcolor: activeButton === 'withdraw' ? '#9CFF1F' : '#E0E0E0',
                          color: 'black',
                          '&:hover': {
                            bgcolor: activeButton === 'withdraw' ? '#9cff1f' : '#D0D0D0'
                          },
                          borderRadius: 36,
                          flex: { xs: 1, sm: 'initial' },
                          px: { xs: 2, sm: 3 }
          ...
          <Card sx={{ bgcolor: '#fff', color: '#222222' }}>
            <CardContent>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                <Typography variant="subtitle1" color="#222222" fontWeight={500} fontSize={16}>Token</Typography>
                <ArticleOutlinedIcon />
              </Box>
